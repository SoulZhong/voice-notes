...
export const zh = {
  ...
  "notes.player.cutSpan": "已删减(播放跳过,可在播放器下方恢复)",
  "notes.edits.deleteRange": "删除圈内 {start} – {end}",
  "notes.edits.deleteTitle": "非破坏性:只影响播放与导出,原始录音不动,可随时恢复",
...
export const en = {
  ...
  "notes.player.cutSpan": "Cut (skipped in playback; restore below the player)",
  "notes.edits.deleteRange": "Delete selection {start} – {end}",
  "notes.edits.deleteTitle": "Non-destructive: affects playback and exports only; the recording is untouched and can be restored anytime",
