...
export const zh = {
  ...
  "notes.banner.aiUnconfigured": "这场没有做 AI 整理：会后 AI 的执行体还没配置完成，主题标题与精修都已跳过。",
  "notes.banner.aiConfigure": "去配置",
  "notes.banner.aiNotRun": "这场没有做 AI 整理（录制时执行体尚未配置完成）。",
...
export const en = {
  ...
  "notes.banner.aiUnconfigured":
    "No AI processing for this meeting: the post-meeting AI executor is not fully configured, so the topic title and refined draft were skipped.",
  "notes.banner.aiConfigure": "Configure",
  "notes.banner.aiNotRun": "No AI processing for this meeting (the executor was not configured when it was recorded).",
