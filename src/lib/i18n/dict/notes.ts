...
export const zh = {
  ...
  "notes.edits.count": "已删 {n} 段 · 共 {secs} 秒",
  "notes.edits.manage": "管理",
  "notes.edits.collapse": "收起",
  "notes.edits.restore": "恢复",
  "notes.edits.restoreAll": "全部恢复",
  "notes.edits.undo": "撤销刚才的删除",
...
export const en = {
  ...
  "notes.edits.count": "{n} cut(s) · {secs}s removed",
  "notes.edits.manage": "Manage",
  "notes.edits.collapse": "Hide",
  "notes.edits.restore": "Restore",
  "notes.edits.restoreAll": "Restore all",
  "notes.edits.undo": "Undo last delete",
