...
export type NoteMeta = {
  ...
  attendees?: string[];
  /** 本篇隐藏的日历参会人键(邮箱或名字,小写)。 */
  attendees_removed?: string[];
...
/** 本篇隐藏的日历参会人整表替换(键=邮箱或名字)。 */
export const setNoteAttendeesRemoved = (id: string, keys: string[]) =>
  invoke<void>("set_note_attendees_removed", { id, keys });
