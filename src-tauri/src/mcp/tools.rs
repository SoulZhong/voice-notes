    ...
    fn list_notes_pages_and_filters_by_time() {
        ...
        store::write_refined_atomic(
            ...
            &store::RefinedDoc {
                ...
                llm_model: None,
                stages: store::RefineStages { filter: "done".into(), recluster: "done".into(), llm: "done".into(), entities: "off".into(), relations: "off".into() },
                discarded_seqs: vec![],
                entities: vec![],
    ...
    fn apply_refined_texts_validates_note_then_writes() {
        ...
        store::write_refined_atomic(
            ...
            &store::RefinedDoc {
                ...
                generated_at: "t".into(),
                llm_model: None,
                stages: store::RefineStages { filter: "done".into(), recluster: "done".into(), llm: "off".into(), entities: "off".into(), relations: "off".into() },
                discarded_seqs: vec![],
                entities: vec![],
                graph_extraction: None,
                relations: vec![],
