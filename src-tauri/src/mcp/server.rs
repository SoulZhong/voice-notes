...
impl VnMcp {
    ...
    #[tool(description = "读取一场会议笔记全文。segments 给逐句结构化(含说话人/时间戳),markdown/text 给渲染稿;有 AI 修订稿时默认优先修订稿。")]
    ...
    #[tool(description = "把 Aing 修订写回笔记的修订稿:按段落下标整段替换文本(只能改文本,说话人/时间戳/段落数不可变)。\
