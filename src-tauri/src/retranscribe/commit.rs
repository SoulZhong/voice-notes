...
mod tests {
    ...
    fn commit_backs_up_then_replaces_everything() {
        ...
        let speakers = BTreeMap::from([("S1".to_string(), SpeakerMeta {
            name: "张三".into(), sources: vec!["mic".into()], centroid: None, count: 0, person_id: None, multi_speaker: false, reserved_by: None, split_born: false, hint_person: None,
        })]);
    ...
    fn union_preserves_old_entry_when_new_table_has_no_colliding_id() {
        ...
        let old_s1 = SpeakerMeta {
            ...
            count: 7, person_id: Some("P1".into()), multi_speaker: false, reserved_by: None, split_born: false, hint_person: None,
        };
        ...
        let new_s2 = SpeakerMeta {
            name: "李四".into(), sources: vec!["mic".into()], centroid: None, count: 3, person_id: None, multi_speaker: false, reserved_by: None, split_born: false, hint_person: None,
        };
    ...
    fn speakers_prewrite_failure_leaves_segments_untouched() {
        ...
        let speakers = BTreeMap::from([("S1".to_string(), SpeakerMeta {
            name: "李四".into(), sources: vec!["mic".into()], centroid: None, count: 0, person_id: None, multi_speaker: false, reserved_by: None, split_born: false, hint_person: None,
        })]);
